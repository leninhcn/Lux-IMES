      ...
      <el-col >
        <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
          <el-form-item label="工号" prop="userName">
            <el-input v-model="queryParams.userName" placeholder="请输入工号" clearable style="width: 240px"
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="厂区" align="center" key="site" prop="site" v-if="columns.showColumn('site')" />
          <el-table-column label="用户ID" align="center" key="userId" prop="userId" v-if="columns.showColumn('userId')" />
          <el-table-column label="工号" align="center" key="userName" prop="userName" v-if="columns.showColumn('userName')"
            :show-overflow-tooltip="true" />
          <el-table-column label="用户昵称" align="center" key="nickName" prop="nickName"
            v-if="columns.showColumn('nickName')" :show-overflow-tooltip="true" />
          <el-table-column label="部门" align="center" key="deptName" prop="deptName" v-if="columns.showColumn('deptName')"
            :show-overflow-tooltip="true" />
        ...
        <el-row :gutter="20">
          <el-col :lg="12">
            <el-form-item label="厂区" prop="site" >
              <el-select v-model="form.site" placeholder="请选择厂区" :disabled="siteupdate" >
                <el-option v-for="(site, index) in siteOptions" :label="site.site" :value="site.site"
                  :key="site.site"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :lg="12">
            <el-form-item label="工号" prop="userName">
              <el-input :disabled="form.userId != undefined" v-model="form.userName" placeholder="请输入工号(用于登陆)" />
            </el-form-item>
          </el-col>
          <el-col :lg="12">
          ...
          <el-col :lg="12">
            <el-form-item label="部门" prop="deptName">
              <el-select
                ...
                clearable
                placeholder="点击输入"
                :remote-method="remoteMethodDeptName"
                :loading="loadingDeptName"
                >
                  <el-option
                    v-for="item in optionstDeptName"
                    :key="item.deptName"
                    :label="item.deptName"
                    :value="item.deptName"
                  />
...
import { sitelist } from '@/api/system/site'
import { deptlistget } from '@/api/mescommon/mesget'
...
const columns = ref([
  ...
  { key: 11, label: `厂区`, visible: true, prop: 'site' }
])
