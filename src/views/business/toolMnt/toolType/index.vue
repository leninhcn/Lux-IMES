<template>
    <div class="app-container">
        ...
        <el-row :gutter="10" mb-1>
            <el-col :span="1.5">
                <el-button type="primary" plain icon="plus" @click="vc.handleAdd"
                    v-hasPermi="['datacenter:mntntooltype:add']">{{ $t('btn.add') }}</el-button>
            </el-col>
            <el-col :span="1.5">
                <el-button type="success" plain icon="edit" @click="vc.handleUpdate" :disabled="!state.currentMType"
                    v-hasPermi="['datacenter:mntntooltype:update']">
                    {{ $t('btn.edit') }}
                </el-button>
            </el-col>
            <el-col :span="1.5">
        ...
        <el-table height="480px" v-loading="vs.loading" :data="state.data" highlight-current-row
            ...
            <el-table-column :label="$t('mntntooltype.toolingType')" align="center" prop="toolingType" />
            <el-table-column :label="$t('mntntooltype.toolingTypeDesc')" align="center" prop="toolingTypeDesc" />
            <el-table-column :label="$t('mntntooltype.locationQty')" align="center" prop="locationQty" />
            ...
            <el-table-column :label="$t('mntntooltype.options')" align="center" prop="options" />
            <el-table-column :label="$t('mntntooltype.createEmpNo')" align="center" prop="createEmpNo" />
            <el-table-column :label="$t('mntntooltype.createTime')" align="center" prop="createTime" />
            <el-table-column :label="$t('mntntooltype.updateEmpNo')" align="center" prop="updateEmpNo" />
            <el-table-column :label="$t('mntntooltype.updateTime')" align="center" prop="updateTime" />
        </el-table>
        ...
        <el-dialog :title="vs.editTitle" v-model="vs.showEdit" width="500px" append-to-body>
            <el-form ref="EditForm" :model="state.editForm" :rules="vc.EditFormRules" label-width="90px">
                <el-form-item :label="$t('mntntooltype.toolingType')" prop="toolingType">
                    <el-input v-model="state.editForm.toolingType" placeholder="" />
                </el-form-item>
                <el-form-item :label="$t('mntntooltype.toolingTypeDesc')" prop="toolingTypeDesc">
                    <el-input v-model="state.editForm.toolingTypeDesc" placeholder="" />
                </el-form-item>
                <el-form-item :label="$t('mntntooltype.locationQty')" prop="locationQty">
                    <el-input-number min="0" v-model="state.editForm.locationQty" placeholder="" />
                </el-form-item>
                <el-form-item :label="$t('mntntooltype.options')" prop="options">
                    <el-input v-model="state.editForm.options" placeholder="" />
                </el-form-item>
            </el-form>
            <template #footer>
